...

{
  ...
  projectDetails: {
    ...
    description: "Web3 game for pixel-lovers",
    sector: "Play", 
...
},
{
  ...
  projectDetails: {
    ...
    description: "Play web3 games on the Gala Games hub",
    sector: "Play", 
...
},
{
  ...
  projectDetails: {
    ...
    description: "Play web3 games on the Immutable network",
    sector: "Play", 
...
},
{
  ...
  projectDetails: {
    ...
    description: "Purchase Axies and play the revolutionary web3 game",
    sector: "Play", 
...
},
{
  ...
  projectDetails: {
    ...
    description: "Jump into the SuperVerse and play web3 games",
    sector: "Play", 
...
},
{
  ...
  projectDetails: {
    ...
    description: "AAA turn-based RPG web3 game",
    sector: "Play", 
